    ...
    public partial class FoorOrder : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodLocalizations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodLocalizations_Food_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Food",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodLocalizations_Locales_LocaleId",
                        column: x => x.LocaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodInOrders_Food_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Food",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodInOrders_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodInOrders_OrderId",
                table: "FoodInOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodLocalizations_FoodId",
                table: "FoodLocalizations",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodLocalizations_LocaleId",
                table: "FoodLocalizations",
                column: "LocaleId");
